...
if ($_GET["action"] == "fetch_fee_list_details") {
    ...
    <div class="card">
        <div class="card-header">
            ...
            <input class="form-control  " style="width:30%;" type="search" placeholder="Search" id="search-student"
                onkeyup="searchStudent()" aria-label="Search">
            <form method="POST" class=' float-right' action="export_hostel_full_report_list.php">
                <input type="hidden" name="course_id" value="<?= $course_id ?>" />
                <input type="hidden" name="academic_year" value="<?= $academic_year ?>" />
                <input type="hidden" name="action" value="export_fees_details" />
                <button type="submit" class="btn btn-warning float-left"><i class="fa fa-download"></i> Export List</button>
            </form>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    if ($resultTblFeePaid->num_rows > 0)
                                        while ($rowTblFeePaid = $resultTblFeePaid->fetch_assoc()) {
                                            ...
                                            // echo $rowTblFeePaid["paid_amount"];
                                            // echo "<br>";
                                            // echo $rowTblFeePaid["transaction_no"];
                                            // echo "<br>";
                                            // echo "<br>";
                                            // echo $arrayPaidId[$i];
                                            // echo "<br>";
...
?>
<script src="http://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo="
