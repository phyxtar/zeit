...
if ($_GET["action"] == "fetch_student_fee_details") {
    ...
    if (!empty($studentRegistrationNo)) {
        ...
        if ($result->num_rows > 0) {
            ...
            ?>
            <div class="row">
                <!-- getting the student detail for showing the student details -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                    ...
                                    <form method="POST" id="PayFeeForm" onSubmit="return ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 table-responsive" style="overflow-x:auto;">
                                                <h5>Fee Details of <b><a href="javascript:void(0);">
                                                            <?php echo $row["course_name"] . " | " . $completeSessionOnlyYear; ?>
                                                        </a></b>
                                                </h5>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($arrayTblFee as $arrayTblFeeUpdate) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!-- particular -->
                                                                <td>
                                                                    <?php echo date("d-m-Y", strtotime($arrayTblFeeUpdate->fee_last_date)) ?>
                                                                </td> <!--  last date -->
                                                                <td>&#8377;
                                                                    <?php echo number_format($arrayTblFeeUpdate->fee_amount); ?>
                                                                </td> <!-- amount -->
                                                                <td>&#8377;
                                                                    <?php echo number_format($arrayTblFeeUpdate->fee_paid); ?>
                                                                </td> <!-- paid -->
                                                                <td>&#8377;
                                                                    <?php echo number_format($arrayTblFeeUpdate->fee_rebate); ?>
                                                                </td> <!-- rebate -->
                                                                ...
                                                                <td><span class="text-red text-bold">&#8377;
                                                                        <?php echo $total_remaing_amount_final = $total_remaining_amount + $fine_by_particular_remaning ?>
                                                                    </span>
                                                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($totalFee); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($totalPaid); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($totalRebate); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($totalRemaining); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($totalFine); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($total_fine_payment); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($total_rebate_fine_payment); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($total_fine_payment_remaining); ?>
                                                            </td>
                                                            <td class="text-bold">&#8377;
                                                                <?php echo number_format($overall_total_paid); ?>
                                                            </td>

                                                            <td class="text-bold"><span class="text-red"> &#8377;
                                                                    <?php echo number_format($totalRemainings); ?>
                                                                </span></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <!-- student rejoin start  -->
                                                <?php include "student_rejoin.php"; ?>
                                                <!-- student rejoin end  -->
                                            </div>
                                            <!-- /.col -->
                                        ...
                                        <br />
                                        <?php include_once "payment_mode.php" ?>
                                        <!-- /.row -->
                                    </form>
                                    <?php
                                ...
                                <?php include_once "paid_info.php" ?>
                            </div>
                            <!-- /.tab-content -->
                        </div><!-- /.card-body -->
                    </div>
