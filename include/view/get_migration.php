...
<table id="dtHorizontalExample" class="table table-bordered table-striped">
    ...
    <tbody>
        <?php
            ...
            $sql = "SELECT * FROM `tbl_apply_migration` WHERE `status` = '$visible'  && `course_id`='$course_id' && `fee_academic_year`='$academic_year'
                                ORDER BY `course_id` ASC
                                ";
            $result = $con->query($sql);
            }else{
                $sql = "SELECT * FROM `tbl_apply_migration` WHERE `status` = '$visible' ORDER BY `course_id` ASC
                ";
            $result = $con->query($sql);
            }
        ...
        <tr>
            ...
            <?php
                        ...
                        ?>
            <td><?php echo $row_sem["migration_fee"] ?></td>

            <td><?php echo $row_sem["migrationfee_status"] ?></td>
            ...
            <td class="project-actions text-center">
                ...
                <button class="btn btn-danger btn-sm"
                    onclick="document.getElementById('delete_get_migration<?php echo $row["migration_id"]; ?>').style.display='block'">
            ...
            <div id="delete_get_migration<?php echo $row["migration_id"]; ?>" class="w3-modal" style="z-index:2020;">
                <div class="w3-modal-content w3-animate-top w3-card-4" style="width:40%">
                    <header class="w3-container" style="background:#343a40; color:white;">
                        <span
                            onclick="document.getElementById('delete_get_migration<?php echo $row["migration_id"]; ?>').style.display='none'"
                            class="w3-button w3-display-topright">&times;</span>
                    ...
                    <form id="delete_migration_form<?php echo $row["migration_id"]; ?>" role="form" method="POST">
                        <div class="card-body">
                            ...
                            <div class="col-md-12" align="center">
                                ...
                                <div class="col-md-12" id="delete_loader_section<?php echo $row["migration_id"]; ?>">
                                </div>
