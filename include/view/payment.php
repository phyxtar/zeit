                        ...
                        <form method="POST" id="PayFeeForm" onSubmit="return :false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 table-responsive" style="overflow-x:auto;">
                                    ...
                                    <script>
                                    alert(
                                        ' <?= $row["admission_first_name"] . " " . $row["admission_last_name"]; ?> has rejoined hostel on <?= date('d-m-Y',strtotime($hostel_date_result['re_join_date']))  ?>  Previous HOSTEL FEES details are as below \n\n  As Rejoing date is after the previous fees addition to the portal you need to first make an update to the last hostel fees   '
                                    );
                                    </script>
                        ...
                        function completeCalculation() {
                            ...
                            function finecalculator(lastDate, particular_paid_amount1, particular_id) {
                                ...
                                if (particular_paid_amount1 != 0) {
                                    ...
                                    document.getElementById("particular_fine_remaining[" + particular_id + "]").value =
