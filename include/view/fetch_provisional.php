<?php
if ($_GET["action"] == "fetch_provisional") {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            ?>
                            <td>
                                <?= $row_id["admission_first_name"] . " " . $row_id["admission_middle_name"] . $row_id["admission_last_name"] ?>
                            </td>
                            <?php
                            ...
                            ?></td>
                                    ...
                                    echo $divnum ?> % </td> -->
                            <td>
                                <form action=""><a href="provisional?id=<?php echo $row["reg_no"] ?>" target="_blank">Print
                                        Provisional</a>
                                </form>
                            </td>
                        </tr>
