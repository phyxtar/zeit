...
if (isset($_POST["importExcelButton"])) {
    ...
    if ($file == NULL) {
        ...
        while (($filesop = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $sql_year = "SELECT * FROM `tbl_university_details` WHERE  `academic_session` LiKE '%" . $academic_year . "%' ";
            ...
            $sql = "INSERT INTO `tbl_admission_details`(`admission_details_id`,`admission_id`, `student_name`,`course_id`,`academic_year`, `serial_no`,`reg_no`, `roll_no`, `semester_id`,`type`,`create_time` ,`status`) 
                    VALUES (NULL,'$admission_id','$student_name','$course_id','$academic_year','$serial_no','$reg_no','$roll_no','$semester_id','$type','$date_variable_today_month_year_with_timing','$visible')";
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                <div class="input-row">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="images/marksheet/STUDENT_FORMAT.csv"><b
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" onchange="showdesg(this.value)"
