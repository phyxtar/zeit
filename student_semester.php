...
if (isset($_POST["importExcelButton"])) {
    ...
    if ($file == NULL) {
        ...
        while (($filesop = fgetcsv($handle, 1000, ",")) !== false) {
            ...
            $academic_year = "";
            $semester_id = "";
            $student_data = fetchRow('tbl_admission', '`admission_id`=' . $admission_id . '');
            $course_id = $student_data['admission_course_name'];
            $academic_year = $student_data["admission_session"];

            // $sql_semester = "SELECT * FROM `tbl_semester` WHERE `semester`='$semester_name' && `course_id`='$course_id' && `fee_academic_year`='$academic_year' && `status`='$visible' ";
            // $result_semester = mysqli_query($conn, $sql_semester);
            // $row_semester = mysqli_fetch_assoc($result_semester);
            $semester_id = trim($semester_name);
            $sql = "INSERT INTO `tbl_allot_semester`(`allot_id`,`admission_id`,`reg_no`,`course_id`,`academic_year`,`roll_no`, `semester_id`, `type`,`status`,`section`) 
                    VALUES (NULL,'$admission_id','$reg_no','$course_id','$academic_year','$roll_no','$semester_id','$type','$visible','$section')";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="input-row">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                    href="images/marksheet/Allot_STUDENT_FORMAT.csv"><b
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select id="session_id" class="form-control" onchange="showdesg(this.value)"
                                                name="academic_year">
