...
if (isset($_POST['reg_no'])) {
    $student = array();
    for ($i = 0; $i < count($_POST['reg_no']); $i++) {
        $student['admission_id'] = $_POST['admission_id'][$i];
        $student['student_name'] = $_POST['student_name'][$i];
        $student['course_id'] = $_POST['course_id'][$i];
        $student['academic_year'] = $_POST['academic_year'][$i];
        $student['semester_id'] = $_POST['semester_id'][$i];
        $student['serial_no'] = $_POST['serial_no'][$i];
        $student['reg_no'] = $_POST['reg_no'][$i];
        $student['roll_no'] = $_POST['roll_no'][$i];
        $student['type'] = $_POST['exam_type'][$i];
        $student['create_time'] = date('Y-m-d h:m:s');
        $student['admitcard_status'] = '';
        $student['status'] = md5('visible');

        $presult = insertAll('tbl_admission_details', $student);
    }
}
...
<body class="hold-transition sidebar-mini">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select onchange="change_semester(this.value)"
                                                class="form-control rounded-pill" id="course_id" name="course_id">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select onchange="showdesg(this.value)" class="form-control rounded-pill"
                                                id="session" name="academic_year">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rounded-pill" id="sem" name="semester_id">
                                            </select>
                                        </div>
                                    </div>
    ...
    $(document).ready(function() {
        $('#fetchStudentDataForm').submit(function(event) {
            ...
            $.ajax({
                url: 'include/view.php?action=fetch_student_list_details_for_marksheet',
                type: 'POST',
