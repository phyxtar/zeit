    ...
    if (isset($_POST["paidId"])) {
        ...
        if (strtolower($row["admission_hostel"]) == "yes") {
            ...
            if ($resultTblFee->num_rows > 0)
                while ($rowTblFee = $resultTblFee->fetch_assoc()) {
                    ...
                    // if student not exits with hostel fee then student show into the this particular of the block
        ...
        if ($resultTblFeePaid->num_rows > 0) {
            while ($rowTblFeePaid = $resultTblFeePaid->fetch_assoc()) {
                ...
                $total_balance_amount_after_pay = ($arrayTblFeeUpdate->balace_amount + (int)$rowTblFeePaid["balance"]);
            }
        }
        if ($row["fine"] != "")
            $fineAmount = $row["fine"];
                                                    ...
                                                    <td>
                                                        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tbl_grid" style="border-color: #4dc8ee !important;"><br>
                                                            ...
                                                            <tr height="25">
                                                                ...
                                                                <td width="30%" align="center" valign="middle" class="admin">Rs. <?php echo $row["balance"] > 0 ? $row["balance"] :  $totalFee - get_total_fee_paid($row['admission_id'])   ?>.00</td>
                                                            </tr>
                                                            ...
                                                            <tr height="25">
                                                                <td align="left" colspan="6" style="padding-right:25px; font-size: 10px;" class="admin">Note:- Fees once paid will not be refunded and please keep this slip for your reference. If there are any questions regarding your UTR/NEFT/CHEQUE NO. You will receive a call regarding the same. Your receipt shall not be a confirmation of payment in such case.
                                                    ...
                                                    <td>
                                                        <table width="95%" border="0" cellspacing="2" cellpadding="0" align="center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" class="narmal">Admission No. </td>
                                                                <td align="left" class="narmal">:</td>
                                                                <td align="left" class="narmal"><?php echo $row["course_name"]; ?><?php echo date("y", strtotime($row['university_details_academic_start_date'])) ?><?php echo date("y", strtotime($row['university_details_academic_end_date'])); ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="narmal">Registration No.</td>
                                                                <td align="left" class="narmal">:</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tbl_grid" style="border-color: #4dc8ee !important;">
                                                            ...
                                                            <tr height="25">
                                                                <td align="left" colspan="4" style="padding-right:25px; font-size: 10px;" class="admin">Note:- Fees once paid will not be refunded and please keep this slip for your reference. If there are any questions regarding your UTR/NEFT/CHEQUE NO. You will receive a call regarding the same. Your receipt shall not be a confirmation of payment in such case.
