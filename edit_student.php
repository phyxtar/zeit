...
include_once 'include/function/student_leave.php';
$hod = $_SESSION['admin']['admin_type'];


if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Fetch current record from the database
    $query = "SELECT * FROM tbl_admission WHERE admission_id = '$id'";
    $result = $con->query($query);
    $row1 = $result->fetch_assoc(); // Fetching data from the database
}
    ...
    if (isset($_POST['submit'])) {
        if (isset($_GET['id'])) {
            ...
            if ($_FILES["admission_profile_image"]["name"] != "") {
                ...
                $file = $row1['admission_profile_image'];
            }
		...
		if ($_FILES["admission_character_certificate"]["name"] != "") {
            ...
            // Update query to include the image (whether new or existing)
            $update =  "UPDATE `tbl_admission` SET 
            `admission_form_no`='" . $_POST['admission_form_no'] . "',
            `admission_no`='" . $_POST['admission_no'] . "',
            `hostel_leave_date`='" . $_POST['hostel_leave_date'] . "',
            `admission_title`='" . $_POST['admission_title'] . "',
            `admission_first_name`='" . $_POST['admission_first_name'] . "',
            `admission_middle_name`= '" . $_POST['admission_middle_name'] . "',
            `admission_last_name`='" . $_POST['admission_last_name'] . "',
            `admission_course_name`='" . $_POST['admission_course_name'] . "',
            `admission_session`='" . $_POST['admission_session'] . "',
            `admission_dob`='" . $_POST['admission_dob'] . "',
            `admission_nationality`='" . $_POST['admission_nationality'] . "',
            `admission_aadhar_no`='" . $_POST['admission_aadhar_no'] . "',
            `date_of_admission`='" . $_POST['date_of_admission'] . "',
            `admission_category`='" . $_POST['admission_category'] . "',
            `admission_gender`='" . $_POST['admission_gender'] . "',
            `admission_username`='" . $_POST['admission_username'] . "',
            `admission_password`='" . md5($_POST['admission_password']) . "',
            `admission_blood_group`='" . $_POST['admission_blood_group'] . "',
            `apaar_id`='" . $_POST['apaar_id'] . "',
            `specialization_id`='" . $_POST['specialization_id'] . "',
            `specialization_id_dual`='" . $_POST['specialization_id_dual'] . "',
            `admission_hostel`='" . $_POST['admission_hostel'] . "',
            `admission_transport`='" . $_POST['admission_transport'] . "',
            `admission_profile_image`='" . $file . "',
            `admission_residential_address`='" . $_POST['admission_residential_address'] . "',
            `admission_state`='" . $_POST['admission_state'] . "',
            `admission_city`='" . $_POST['admission_city'] . "',
            `admission_district`='" . $_POST['admission_district'] . "',
            `admission_pin_code`='" . $_POST['admission_pin_code'] . "',
            `admission_home_landlineno`='" . $_POST['admission_home_landlineno'] . "',
            `admission_mobile_student`='" . $_POST['admission_mobile_student'] . "',
            `admission_father_phoneno`='" . $_POST['admission_father_phoneno'] . "',
            `admission_emailid_father`='" . $_POST['admission_emailid_father'] . "',
            `admission_emailid_student`='" . $_POST['admission_emailid_student'] . "',
            `admission_father_name`='" . $_POST['admission_father_name'] . "',
            `admission_father_whatsappno`='" . $_POST['admission_father_whatsappno'] . "',
            `admission_mother_name`='" . $_POST['admission_mother_name'] . "',
            `admission_high_school_board_university`='" . $_POST['admission_high_school_board_university'] . "',`admission_high_school_college_name`='" . $_POST['admission_high_school_college_name'] . "',
            `admission_high_school_passing_year`='" . $_POST['admission_high_school_passing_year'] . "',
            `admission_high_school_per`='" . $_POST['admission_high_school_per'] . "',
            `admission_high_school_subjects`='" . $_POST['admission_high_school_subjects'] . "',
            `admission_intermediate_board_university`='" . $_POST['admission_intermediate_board_university'] . "',`admission_intermediate_college_name`='" . $_POST['admission_intermediate_college_name'] . "',
            `admission_intermediate_passing_year`='" . $_POST['admission_intermediate_passing_year'] . "',
            `admission_intermediate_per`='" . $_POST['admission_intermediate_per'] . "',
            `admission_intermediate_subjects`='" . $_POST['admission_intermediate_subjects'] . "',
            `admission_graduation_board_university`='" . $_POST['admission_graduation_board_university'] . "',`admission_graduation_college_name`='" . $_POST['admission_graduation_college_name'] . "',
            `admission_graduation_passing_year`='" . $_POST['admission_graduation_passing_year'] . "',
            `admission_graduation_per`='" . $_POST['admission_graduation_per'] . "',
            `admission_graduation_subjects`='" . $_POST['admission_graduation_subjects'] . "',
            `admission_post_graduation_board_university`='" . $_POST['admission_post_graduation_board_university'] . "',`admission_post_graduation_college_name`='" . $_POST['admission_post_graduation_college_name'] . "',`admission_post_graduation_others`='" . $_POST['admission_post_graduation_others'] . "',
            `admission_post_graduation_per`='" . $_POST['admission_post_graduation_per'] . "',
            `admission_post_graduation_subjects`='" . $_POST['admission_post_graduation_subjects'] . "',
            `admission_others_board_university`='" . $_POST['admission_others_board_university'] . "',
            `admission_others_college_name`='" . $_POST['admission_others_college_name'] . "',
            `admission_others_passing_year`='" . $_POST['admission_others_passing_year'] . "',
            `admission_others_per`='" . $_POST['admission_others_per'] . "',
            `admission_others_subjects`='" . $_POST['admission_others_subjects'] . "',
            `admission_tenth_marksheet`='" . $file1 . "',
            `admission_tenth_passing_certificate`='" . $file2 . "',
            `admission_twelve_markesheet`='" . $file3 . "',
            `admission_twelve_passing_certificate`='" . $file4 . "',
            `admission_graduation_marksheet`='" . $file5 . "',
            `admission_recent_character_certificate`='" . $file6 . "',
            `admission_other_certificate`='" . $file7 . "',
            `admission_character_certificate`='" . $file8 . "',
            `admission_course1`='" . $_POST['admission_course1'] . "',
            `admission_board_university1`='" . $_POST['admission_board_university1'] . "',
            `admission_year_of_passing1`='" . $_POST['admission_year_of_passing1'] . "',
            `admission_percentage1`='" . $_POST['admission_percentage1'] . "',
            `admission_course2`='" . $_POST['admission_course2'] . "',
            `admission_board_university2`='" . $_POST['admission_board_university2'] . "',
            `admission_year_of_passing2`='" . $_POST['admission_year_of_passing2'] . "',
            `admission_percentage2`='" . $_POST['admission_percentage2'] . "',
            `admission_course3`='" . $_POST['admission_course3'] . "',
            `admission_board_university3`='" . $_POST['admission_board_university3'] . "',
            `admission_year_of_passing3`='" . $_POST['admission_year_of_passing3'] . "',
            `admission_percentage3`='" . $_POST['admission_percentage3'] . "',
            `admission_course4`='" . $_POST['admission_course4'] . "',
            `admission_board_university4`='" . $_POST['admission_board_university4'] . "',
            `admission_year_of_passing4`='" . $_POST['admission_year_of_passing4'] . "',
            `admission_percentage4`='" . $_POST['admission_percentage4'] . "',
            `admission_course5`='" . $_POST['admission_course5'] . "',
            `admission_board_university5`='" . $_POST['admission_board_university5'] . "',
            `admission_year_of_passing5`='" . $_POST['admission_year_of_passing5'] . "',
            `admission_percentage5`='" . $_POST['admission_percentage5'] . "',
            `admission_name_of_org1`='" . $_POST['admission_name_of_org1'] . "',
            `admission_designation1`='" . $_POST['admission_designation1'] . "',
            `admission_duration1`='" . $_POST['admission_duration1'] . "' ,
            `approval`='" . $_POST['approval'] . "' ,
            `hostel_join_date`='" . $_POST['hostel_join_date'] . "'
             WHERE admission_id = '" . $_GET['id'] . "'";
            
            // Execute the update query
            if ($con->query($update)) {
                // Call studentLeave function (assuming it's defined elsewhere)
                studentLeave($_GET['id'], $_POST['re_join_date'], $_POST['hostel_leave_date']);
    
                // Prepare SMS message
                $admission_first_name = $_POST['admission_first_name'];
                $admission_username = $_POST['admission_username'];
                $admission_password = $_POST['admission_password'];
                $admission_mobile_student = $_POST['admission_mobile_student'];
...
} elseif(isset($_POST['specialization_update'])) {

    $update_spec =  "UPDATE `tbl_admission` SET 
            `specialization_id`='" . $_POST['specialization_id'] . "' WHERE admission_id = '" . $_GET['id'] . "'";
    if ($con->query($update_spec)) {
        // Success message
        echo "<script>
        alert('Student Updated successfully!!!');
        location.replace('student_list');
    ...
    <div class="wrapper">
                    ...
                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="admission_middle_name"
                                            value="<?php echo $row1['admission_middle_name']; ?>" class="form-control" readonly>
                                    </div>

                                    <div class="col-4">
                                        <label>Last Name</label>
                                        <input type="text" name="admission_last_name"
                                            value="<?php echo $row1['admission_last_name']; ?>" class="form-control" readonly>
                                    </div>

                                    <div class="col-4">
                                        <label>Date Of Birth</label>
                                        <input type="date" name="admission_dob"
                                            value="<?php echo $row1["admission_dob"]; ?>" class="form-control" readonly>
                                    </div>

                                    <div class="col-4">
                                        <label>Father Name</label>
                                        <input type="text" name="admission_father_name"
                                            value="<?php echo $row1["admission_father_name"]; ?>" class="form-control" readonly>
                                    </div>

                                    <div class="col-4">
                                        <label>Course</label>
                                        <select name="admission_course_name" class="form-control" id="course" readonly>
                                            <?php
											$sql_c = "SELECT * FROM `tbl_course`
									   WHERE `status` = '$visible' AND `course_id` = '" . $row1["admission_course_name"] . "';
									   ";
                                    ...
                                    <div class="col-4">
                                        <label>Session</label>
                                        <select id="session_check" name="admission_session" class="form-control" readonly>
                                            <?php
        $sql_c = "SELECT * FROM `tbl_university_details`
                  WHERE `status` = '$visible' AND `university_details_id` = '". $row1["admission_session"] ."'";
        $result_c = $con->query($sql_c);
        while ($row_c = $result_c->fetch_assoc()) {
            $completeSessionStart = explode("-", $row_c["university_details_academic_start_date"]);
            $completeSessionEnd = explode("-", $row_c["university_details_academic_end_date"]);
        ...
        ?>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="specialization_id" class="form-control">
                                            <?php
                                            if ($row1['specialization_id'] != '' OR $row1['specialization_id'] != null) {
                                                $spec_fetch1 = "SELECT * FROM `tbl_specialization` WHERE `id` = '" . $row1['specialization_id'] . "'";
                                            $result_spec1 = $con->query($spec_fetch1);
                                            while($row_spec1 = $result_spec1->fetch_assoc()) {
                                                ?>
                                                <option value="<?php echo $row_spec1['id']; ?>"><?php echo $row_spec1['sp_name']; ?></option>
                                                <?php
                                                }
                                            
                                                $course_id = $row1['admission_course_name'];
                                            $spec_fetch2 = "SELECT * FROM `tbl_specialization` WHERE `course_id` = '" . $course_id . "'";
                                            $result_spec2 = $con->query($spec_fetch2);
                                            
                                            while($row_spec2 = $result_spec2->fetch_assoc()) {
                                                ?>
                                                <option value="<?php echo $row_spec2['id']; ?>"><?php echo $row_spec2['sp_name']; ?></option>
                                                <?php
                                                } ?>
                                                <option value="">- Select -</option>
                                          <?php  } else { ?>
                                            <option value="">- Select -</option>
                                            <?php  $course_id = $row1['admission_course_name'];
                                            $spec_fetch = "SELECT * FROM `tbl_specialization` WHERE `course_id` = '" . $course_id . "'";
                                            $result_spec = $con->query($spec_fetch);
                                    ...
                                    <div class="col-4">
                                        <label>Dual Specialization(If there's dual)</label>
                                        <select name="specialization_id_dual" class="form-control">
                                            <?php
                                            if ($row1['specialization_id_dual'] != '' OR $row1['specialization_id_dual'] != null) {
                                                $spec_fetch1 = "SELECT * FROM `tbl_specialization` WHERE `id` = '" . $row1['specialization_id_dual'] . "'";
                                            $result_spec1 = $con->query($spec_fetch1);
                                            while($row_spec1 = $result_spec1->fetch_assoc()) {
                                                ?>
                                                <option value="<?php echo $row_spec1['id']; ?>"><?php echo $row_spec1['sp_name']; ?></option>
                    ...
                    <div class="col-md-6">
                        <input type="hidden" name="action" value="specialization_update" />
                        <input type="submit" class="btn btn-primary" name="specialization_update" value="Submit" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="approval" class="form-control">
                                            <option value="<?php echo $row1['approval']; ?>">
                                                <?php echo $row1['approval']; ?></option>
                                    ...
                                    <div class="col-4">
                                        <label>Course</label>
                                        <select name="admission_course_name" class="form-control" id="course"
                                            onchange="change_semester(this.value); alert('You are changing the course of the student, please delete the particular and add it back to the respective course.');">
                                            <?php
											$sql_c = "SELECT * FROM `tbl_course`
                                    ...
                                    <!-- <div class="col-4">
                                        <label>Session</label>
                                        <select id="session_check" name="admission_session" class="form-control">
                                            <?php
											$sql_c = "SELECT * FROM `tbl_university_details`
									   WHERE `status` = '$visible';
									   ";
        ...
        ?>
                                    ...
                                    <div class="col-4">
                                        <label>Date Of Birth</label>
                                        <input type="date" name="admission_dob"
                                            value="<?php echo $row1["admission_dob"]; ?>" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <input type="date" name="hostel_leave_date"
                                                    value="<?php echo $row1["hostel_leave_date"]; ?>"
                                                    class="form-control">
                                            </div>
                                            <div class="col-4 mt-4 pt-2">
                                                <!-- here to log of the student hotel leave -->
                                    ...
                                    <?php } ?>
                                    <?php if ($row1['hostel_leave_date'] != '') { ?>
                                    <div class="col-4">
                                        <label>Hostel Rejoin Date </label>

                                        <input type="date"
                                            value="<?= fetchRow('tbl_student_hostel_leave', '`student_id`=' . $_GET["id"] . '  && `re_join_date`!="" order by id desc')['re_join_date']  ?>"
                                            name="re_join_date" class="form-control">
                                    </div>
                                    <?php } ?>
                    ...
                    <input type="text" name="apaar_id" class="form-control"
                      value="<?php echo $row1["apaar_id"]; ?>">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="date" name="hostel_join_date"
                                            value="<?php echo $row1["hostel_join_date"]; ?>" class="form-control">
                                    </div>
                                    <div class="col-4">
                                        <label>Specialization</label>
                                        <select name="specialization_id" class="form-control">
