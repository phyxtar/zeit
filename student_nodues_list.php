...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Student List (No Dues) </title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Student List (No Dues)</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Student List (No Dues)</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Student List (No Dues)</h3>
                                   ...
                                   <div class="col-12" id="error_section"></div>
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rounded-pill " onchange="change_semester(this.value)" name="course_id">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rounded-pill" id="session_id" name="academic_year">
                                    ...
                                    <div class="col-1" style="margin-top: 29px;">
                                        <button type="submit" id="fetchFeeDataButton" class="btn btn-primary rounded-pill ">Go</button>
                                    </div>
                                </div>
                            </div>
                        </form>
