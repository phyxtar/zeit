                            ...
                            <div class="card-body" style="margin-top: 0px;">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div class="form-group">
                                            <label> Year </label>
                                            <select class="form-control" name="year_of_present">
                                                <option value="" selected> <?= date('Y') ?></option>
                                                <?php for ($i = date('Y')-1; $i >=2017 ; $i--) { ?>
                                                <option value="<?= $i ?>"><?= $i ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type">
                                                <option value="all">All</option>
                                                <option value="leave">Leave Student</option>
                ...
                success: function(result) {
                    ...
                    if (result == 0) {
                        $('#error_section').append(
                            '<div id = "response"><div class="alert alert-warning alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="icon fas fa-ban"></i> Please select Required Fields!!!</div></div>'
                            );
                    } else {
