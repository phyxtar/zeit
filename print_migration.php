...
<body class="" style="">
    ...
    <table width="740" border="0" align="center" class="bg-logo" style="padding-top: 20px;">
        <tr>
       ...
       ?>
        ...
        <tr>
            <td>
                ...
                $sql_admission_dob = "SELECT admission_dob FROM `tbl_admission` WHERE `admission_id` = '$admission_id'";
                $result_admission_dob = $con->query($sql_admission_dob);
                $row_admission_dob = $result_admission_dob->fetch_assoc();
                $admission_dob = date("d-m-Y", strtotime($row_admission_dob['admission_dob']));
                ?>
                <p class="row3">Date Of Birth&nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                        class="undeline"><?php echo $admission_dob; ?></span>
                </p>
            </td>
        </tr>
        <tr>
            <td>
                ...
                $year_of_admission = date("d-m-Y", strtotime($row_admission_date['date_of_admission']));
                ?>
                <p class="row3">Date Of Admission : &nbsp;<span
                        class="undeline"><?php echo $year_of_admission; ?></span>
                </p>
            </td>
        </tr>
        ...
        <!-- <tr class="flex-row">
            <td>
                <p class="row3"> &nbsp;&nbsp;Registration No : <span
                        class="undeline"><?php echo $row_migration['registration_no']; ?></span>
                </p>
            </td>
            <td>
                <?php
                ...
                ?>
                <p class="row3">Year of Registration : &nbsp;<span class="undeline"><?php echo $year_of_admission; ?>
                    </span>
                </p>
            </td>
        </tr> -->
        <tr>
            <td>
                <div class="row2">
                    <p>Registration No :
                        <span><?php echo $row_migration['registration_no']; ?></span>
                    </p>
                    <?php
                // $admission_id = $_SESSION['user']['admission_id'];
                $sql_admission_date = "SELECT date_of_admission FROM `tbl_admission` WHERE `admission_id` = '$admission_id'";
                ...
                $year_of_admission = date("Y", strtotime($row_admission_date['date_of_admission']));
                ?>
                    <p>Year of Registration : <span class="undelinedate"><?php echo $year_of_admission; ?></span></p>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p class="row3">Branch / Department : &nbsp;<span
                        class="undeline"><?php echo $row_course['course_name']; ?></span>
                </p>
            </td>
        </tr>
        <tr>
            <td style="justify-content: normal;display: flex;">
                <p class="row3 ">Passing Year : &nbsp;<span
                        class="undeline"><?php echo $row_migration['name_of_the_exam']; ?></span>
                </p>
                <p class="row3">Semester : &nbsp;<span class="undeline"><?php echo $row_migration['semester']; ?>
        ...
        <tr>
            <td>
                <p class=" row3 ">Status : &nbsp;<span class=" undeline">
                        <?php echo $row_migration['passfail']; ?></span>
                </p>
            </td>
        </tr>
    </table>
    <p class="rowpara">It is informed that the University has no objection to Her / His Migration to another University.
    </p>
    <div class="row4">
        <div>
            <p src="data:image/jpeg;base64,<?php echo $base64Image; ?>"
                style="top: -2px;height: 20px;width: 130px;content: &quot;&quot;;position: relative;margin-left: 45px;filter: invert(0);margin-bottom: 34px;">
            <p>Administrative Officer</p>
        </div>
        <div>
            <p src="data:image/jpeg;base64,<?php echo $base64Image2; ?>"
                style="left: 20px;margin-bottom: 70px;/* top: -3px; *//* height: 50px; */width: 160px;content: &quot;&quot;;position: relative;/* margin-left: 23px; */filter: invert(0);">
            <p>Registrar</p>
        </div>
    </div>
    <p>
