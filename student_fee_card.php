...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Student Fee Card</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Student Fee Card</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Student Fee Card</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Student Fee Card</h3>
    ...
    <script>
        $(document).ready(function() {
            $('#fetchStudentDataForm').submit(function( event ) {
                ...
                $.ajax({
                    url: 'include/view.php?action=fetch_fee_card_details',
                    type: 'POST',
