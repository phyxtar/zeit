                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-success"><a href="semester_view"
                                        style="color: #fff;"> Semester List</a></button>
                        ...
                        <form role="form" method="POST" id="add_semester_form">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for=""> Required Attendance Percentage </label>
                                            <input class="form-control" type="number" placeholder="Enter Value"
                                                name="attendance">
                                            <small class="text-danger" style="font-weight: 600;">Do not use % symbol,
                                                Enter only numric value. </small>
                                        </div>
                                ...
                                <table class="table table-bordered table-responsive" id="dynamic_field">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="Exam Fine" data-sortable="true" rowspan="2" width="20%">Exam
                                                Fine</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="5%">
                                                <input type="text" id="slno1" value="1" readonly class="form-control"
                                                    style="border:none;" />
                                            </td>
                                            <td width="10%">
                                            ...
                                            <td width="10%">
                                                <input type="text" name="exam_fee[]" placeholder="Exam Fee"
                                                    class="form-control" />
                                            </td>
                                            <td width="20%">
                                                <input type="text" name="exam_fine[]" placeholder="Exam Fine"
                                                    class="form-control" />
                                            </td>
                                            <td width="15%">
                                                <input type="date" name="exam_fee_last_date[]" class="form-control" />
                                            </td>
                                            <td width="10%">
                                            ...
                                            <td width="15%">
                                                <input type="text" name="examination_month[]"
                                                    placeholder="Examination Month" class="form-control" />
                                            </td>
                                            <td width="15%">
                                                <input type="date" name="date_of_result[]" class="form-control" />
                                            </td>
                                            <td width="10%">
