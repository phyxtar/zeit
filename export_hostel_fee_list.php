...
if (isset($_POST["action"]) && $_POST["action"] == "export_hostelfees_details") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $studentName = $row["admission_first_name"] . " " . $row["admission_middle_name"] . " " . $row["admission_last_name"] . " ( " . $row_course['course_name'] . " | " . $row_session["academic_session"] . ")";
    ...
    //Set Filename
    $fileName = "Hostel-Fee-List-Report-" . date('d-m-Y') . ".xlsx";
    //Set BackGround
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', "Hostel Fee List Report");
    //         cellColor('B2', 'FFC107');
    cellColor('B2', 'DC3545');
