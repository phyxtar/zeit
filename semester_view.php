...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Semester </title>
    <!-- Fav Icon -->
                        ...
                        <div class="card"><br><br><br>
                            <div class="card-header">
                                <div class="float-sm-right" style="margin-top: -56px;">
                                    <button type="button" class="btn btn-success"><a href="add_semester" style="color: #fff;">Add Semester</a></button>
                                </div>
                            </div>
    ...
    <div id="add_student" class="w3-modal" style="z-index:2020;">
        <div class="w3-modal-content w3-animate-top w3-card-4" style="width:40%">
            <header class="w3-container" style="background:#343a40; color:white;">
                <span onclick="document.getElementById('add_student').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                <h2 align="center">Add Semester</h2>
            </header>
        </div>
    </div>
