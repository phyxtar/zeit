...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Hostel Room Allotment </title>
...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rounded-pill" id="status" name="status">
                                                <option value="all">All</option>
                                                <option value="occupied">Alloted</option>
                                                <option value="unoccupied">Not Alloted</option>
                                            </select>
                                        </div>
                                    </div>
    ...
    $(document).ready(function() {
        $('#fetchFeeDataForm').submit(function(event) {
            ...
            $.ajax({
                url: 'pages/course_wise_fee_reports/get_vacent_hostel?action=fetch_vacant_list',
                type: 'POST',
