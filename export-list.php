...
if (isset($_POST["action"]) && $_POST["action"] == "export_student_details") {
    ...
    if ($result->num_rows > 0) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', "Student Listt");
        //cellColor('B2', 'FFC107');
        cellColor('B2', 'DC3545');
        ...
        // ----------------------------------------------------------------
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N4', "Date Of Admission");
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V4', " Student Image ");
        fontColor('V4', 'DC3545', '10', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('v4')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('V4')->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        // Data Section Start
        // ----------------------------------------------------------------
        $inc = 5;
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('N' . $inc, $row["date_of_admission"])
                ...
                ->setCellValue('v' . $inc, $row["admission_profile_image"]);
            ...
            $objPHPExcel->getActiveSheet()->getStyle('S' . $inc)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $objPHPExcel->getActiveSheet()->getStyle('T' . $inc)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $objPHPExcel->getActiveSheet()->getStyle('U' . $inc)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $objPHPExcel->getActiveSheet()->getStyle('V' . $inc)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        // ----------------------------------------------------------------
        $objPHPExcel->getActiveSheet()->getStyle('B5:V' . --$inc)->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        // Data Section End
        // ----------------------------------------------------------------
        // Rename worksheet
...
} elseif (isset($_POST["action"]) && $_POST["action"] == "export_hostellers_details") {
    // print_r("Hello");
    // die();
    ...
    if ($result->num_rows > 0) {
        ...
        //Set Filename
        $fileName = "Hostellers-List-" . date('d-m-Y') . ".xlsx";
        //Set BackGround
        function cellColor($cells, $color)
        {
            global $objPHPExcel;
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', "Hostellers List");
        //cellColor('B2', 'FFC107');
        cellColor('B2', 'DC3545');
        fontColor('B2', 'FFFFFF', '16', 'serif', true);
...
} elseif (isset($_POST["action"]) && $_POST["action"] == "export_student_specialization") {
    ini_set('display_errors', 1);
    ini_set('display_startup_errors', 1);
    error_reporting(E_ALL);
    $course_id = $_POST["course_id"];
    ...
    if ($result->num_rows > 0) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I2', "Specialization List");
        //cellColor('B2', 'FFC107');
        cellColor('B2', 'DC3545');
        fontColor('B2', 'FFFFFF', '16', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('B2:G2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('B2:G2')->applyFromArray($thinBorder);

        cellColor('I2', 'DC3545');
        fontColor('I2', 'FFFFFF', '16', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('I2:J2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('I2:J2')->applyFromArray($thinBorder);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('E4')->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F4', "Specialization ID");
        fontColor('F4', 'DC3545', '10', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('F4')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('F4')->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G4', "Dual Specialization ID");
        fontColor('G4', 'DC3545', '10', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('G4')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('G4')->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I4', "Specialization Name");
        fontColor('I4', 'DC3545', '10', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('I4')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('I4')->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J4', "Specialization ID");
        fontColor('J4', 'DC3545', '10', 'serif', true);
        $objPHPExcel->getActiveSheet()->getStyle('J4')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('J4')->applyFromArray($thinBorder);
        // ----------------------------------------------------------------
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D' . $inc, $row["course_name"])
                ->setCellValue('E' . $inc, $row["admission_first_name"] . " " . $row["admission_middle_name"] . " " . $row["admission_last_name"])
                ->setCellValue('F' . $inc, $row["specialization_id"])
                ->setCellValue('G' . $inc, $row["specialization_id_dual"]);
        ...
        // ----------------------------------------------------------------
        $objPHPExcel->getActiveSheet()->getStyle('B5:G' . --$inc)->applyFromArray($thinBorder);

        $spec = "SELECT * FROM `tbl_specialization` WHERE `course_id` = '$course_id' AND `status` = '$visible'";
        $result_spec = $con->query($spec);
        $inc_spec = 5;
        while ($row_spec = $result_spec->fetch_assoc()) {
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('I' . $inc_spec, $row_spec["sp_name"])
                ->setCellValue('J' . $inc_spec, $row_spec["id"]);

            $objPHPExcel->getActiveSheet()->getStyle('I' . $inc_spec)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $objPHPExcel->getActiveSheet()->getStyle('J' . $inc_spec)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

            $inc_spec++;
        }
        $objPHPExcel->getActiveSheet()->getStyle('I5:J' . --$inc_spec)->applyFromArray($thinBorder);
