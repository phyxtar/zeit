...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Hotel Full Reports </title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Hostel Full Reports</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Hotel Full Reports </li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Hotel Full Reports</h3>
                            ...
                            <div class="card-body" style="margin-top: 0px;">
                                <div class="row">
                                    ...
                                    <div class="col-2" style=" display:none;">
                                        <div class="form-group">
                                            <label> Type </label>
                                            <select class="form-control rounded-pill" id="type" name="type">
                                                <option value="all">All</option>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <form method="POST" action="export_hostel_full_report.php">
                                    <input type="hidden" name="course_id" value="all" />
                                    <input type="hidden" name="academic_year" value="all" />
                                    <input type="hidden" name="action" value="export_fees_details" />
                                    <button type="submit" class="btn btn-warning float-left"><i
                                            class="fa fa-download"></i> Export All</button>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('#fetchFeeDataForm').submit(function (event) {
                ...
                $.ajax({
                    url: 'pages/course_wise_fee_reports/hostel_full_reports.php?action=fetch_fee_list_details',
                    type: 'POST',
