...
<form action="update_semester_attendance.php" method="post" enctype="multipart/form-data">
    ...
    <table id="example1" class="table table-bordered table-striped table-responsive" style="overflow-x:auto;">
        <thead>
            <tr>
                ...
                <th class="project-actions text-center">Attendance&nbsp;For
                ...
                <th>Attendance %</br><span>
                        <small class='text-danger' style='font-weight:600'>
                            (please enter only number no need to put %)
                        </small>
                    </span>
                </th>
            </tr>
        ...
        <tbody>
            <?php
                    if ($course_id == "all")
                        ...
                        $sql = "SELECT * FROM `tbl_allot_semester`
                                    WHERE `academic_year` = '$academic_year' && `course_id` = '$course_id' && `semester_id`='$semester_id'";
            ...
            <tr>
                ...
                <?php
                                ...
                                ?>
                <td> <input type="text" name="reg_no[]" class="form-control" value="<?= $row["reg_no"] ?>" readonly>
                </td>
                ...
                <td>
                    <?php
                                    ...
                                    $row_course = $result_course->fetch_assoc();
                                    ?>
                    <select class="form-control semester_name" name="semester_id[]" readonly>
                ...
                <td>
                    <input type="number" class="form-control" value="<?= $row["attendance"] ?>"
                        name="attendance[<?= $row['admission_id'] ?>]" placeholder="Enter value">
                </td>
