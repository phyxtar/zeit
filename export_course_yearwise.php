...
if (isset($_POST["action"]) && $_POST["action"] == "export_fees_details") {
    ...
    //Set Filename
    $fileName = "Course-And-Year-Wise-Dues-Report-" . date('d-m-Y') . ".xlsx";
    //Set BackGround
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', "Course And Year Wise Dues list - " . $row_course['course_name'] . " (" . $completeSessionOnlyYear . ")");
    //         cellColor('B2', 'FFC107');
    cellColor('B2', 'DC3545');
