...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Course & Year Wise Exam Fee Report </title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Course & Year Wise Exam Fee Report </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Course & Year Wise Exam Fee Report </li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Course & Year Wise Exam Fee Report </h3>
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rounded-pill "
                                                onchange="change_semester(this.value)" name="course_id">
