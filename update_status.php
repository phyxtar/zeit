...
if (isset($_POST['admission_id'])) {
    ...
    $sql = "SELECT download_status FROM tbl_migration_form WHERE admission_id = '$admission_id'";
    ...
    if ($result) {
        if ($result->num_rows > 0) {
            ...
            $update_sql = "UPDATE tbl_migration_form SET download_status = '$new_status' WHERE admission_id = '$admission_id'";
