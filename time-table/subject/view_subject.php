                ...
                <div class="content-wrapper">
                        ...
                        <section class="content-header">
                                <div class="container-fluid">
                                        <div class="row mb-2">
                                                <div class="col-sm-6">
                                                        <h1>Time Table Subject LIst</h1>
                                                </div>
                                                <div class="col-sm-6">
                                                        <ol class="breadcrumb float-sm-right">
                                                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                                                <li class="breadcrumb-item active">Time Table Subject LIst</li>
                                                        </ol>
                                                </div>
                                        </div>
                                </div><!-- /.container-fluid -->
                                ...
                                <div class="container-fluid">
                                        ...
                                        <div class="card card-default">
                                                <div class="card-header">
                                                        <div class="row">
                                                                <div class="col-9">
                                                                        <h3 class="card-title">Time Table Subject LIst</h3>
                                                                </div>
                                                                <div class="col-3"><a href="add_subject" type="button" class="btn btn-primary">Add Subjects</a></div>
                                                        </div>
        ...
        <script>
                $(document).ready(function() {
                        $('#fetchStudentDataForm').submit(function(event) {
                                ...
                                $.ajax({
                                        url: 'view.php?action=fetch_student_list',
                                        type: 'POST',
