...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Registration Form List</title>
...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Registration Form List </li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Registration Form List</h3>
                        ...
                        <form role="form" method="POST" id="fetchFeeDataForm">
                            <div class="card-body" style="margin-top: 0px;">
                                <div class="" style="text-align: right; margin-bottom: 10px;">
                                    <a href="export_all_reg.php" class="btn btn-success">Export All</a>
                                </div>
                                <div class="row">
    ...
    <div id="view_exam_lists" class="w3-modal" style="z-index:2020;">
        <div class="w3-modal-content w3-animate-top w3-card-4" style="width:60%">
            <header class="w3-container" style="background:#343a40; color:white;">
                <span id="close-view_exam_lists" style="background-color: #c70013;"
                    class="w3-button w3-display-topright">&times;</span>
                <h2 align="center">Registration Form Details</h2>
            </header>
            <div id="see-section">
    ...
    $(document).ready(function() {
        $('#fetchFeeDataForm').submit(function(event) {
            ...
            $.ajax({
                url: 'include/view.php?action=get_registration_form',
                type: 'POST',
