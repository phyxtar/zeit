...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Examination Pay Fee </title>
    <link rel="icon" href="images/logo.png" />
    <meta name="viewport" content="width=devicmination width, initial-scale=1">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header" style="padding: 0px 0.5rem;">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Examination Pay Fee</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                                <li class="breadcrumb-item active">Examination Pay Fee</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
