...
<body class="hold-transition sidebar-mini" oncontextmenu="return false;">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            WHERE `course_id`='all' && `fee_academic_year` = 'all' && `regfee_status` = 'Active' ";
...
//             echo "</pre>";
                                ...
                                <div class="row">
                                    ...
                                    <div class="card card-secondary" style="width: -webkit-fill-available;">
                                        <div class="card-header">
                                            <h3 class="card-title">APPLICATION FORM FOR REGISTRATION FORM
                                            </h3>
                                        </div>
                                        <div class="card-body table-responsive p-0">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label>Registration Form Fee</label>
                                                            <input type="text" class="form-control  rounded-pill"
                                                                name="amount" value="<?php echo $sem_row['reg_fee']; ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    function fetch_data() {
        ...
        $.ajax({
            url: 'include/view.php?action=fetch_studentregistration_form',
            type: 'POST',
