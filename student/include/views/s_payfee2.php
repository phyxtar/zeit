    ...
    if (!empty($studentRegistrationNo)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (strtolower($row["admission_hostel"]) == "yes") {
                $sqlTblFee = "SELECT *
                                     FROM `tbl_fee`
                                     WHERE `status` = '$visible' AND `fee_particulars` LIKE '%1st installment%' AND `course_id` = '" . $row["admission_course_name"] . "' AND `fee_academic_year` = '" . $row["admission_session"] . "'   ORDER BY `fee_particulars` ASC
                                     ";
                ...
                $sqlTblFee = "SELECT *
                                     FROM `tbl_fee`
                                     WHERE `status` = '$visible' AND `course_id` = '" . $row["admission_course_name"] . "' AND `fee_academic_year` = '" . $row["admission_session"] . "'  AND `fee_particulars` NOT LIKE '%hostel%' AND `fee_particulars` NOT LIKE '%caution%' AND `fee_particulars` LIKE '%1st Installment%' ORDER BY `fee_particulars` ASC
                                     ";
                $resultTblFee = $con->query($sqlTblFee);
                if ($resultTblFee->num_rows > 0)
                    while ($rowTblFee = $resultTblFee->fetch_assoc()) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-body box-profile">
                            <div class="alert alert-success" style="border-left: 5px solid #17a2b8; padding: 20px; margin: 25px 0; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                                ...
                                <div style="font-size: 15px; line-height: 1.6;">
                                    ...
                                    <ul style="margin: 15px 0; padding-left: 20px;">
                                        <li style="margin-bottom: 10px;">
                                            If your status shows as "Not Approved", it likely means your first installment dues are pending. Please clear these dues to proceed with your University Registration Form.
                                        </li>
                                        <li>
                                            If your status shows as "Approved", simply refresh the registration page to begin filling your form.
                                        </li>
                                    </ul>
                                                ...
                                                <table class="table table-bordered table-sm table-responsive-lg">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><span class="text-sucess">status</span></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <span class="text-success text-bold">
                                                                        ...
                                                                        if ($total_remaing_amount_final <= 0) {
                                                                            echo "Approve";

                                                                            
                                                                            $check_sql = "SELECT fee_status_id FROM tbl_fee_status WHERE admission_id='$studentRegistrationNo'";
                                                                            ...
                                                                            if (mysqli_num_rows($check_result) > 0) {
                                                                                ...
                                                                                $particular_id = NULL; 
                                                                                $exam_particular_id = NULL; 
                                                                                $fee_status = NULL; 
                                                                                $exam_status = NULL; 
                                                                                $manual_status = 0; 

                                                                                $insert_sql = "INSERT INTO tbl_fee_status 
                                                                                            (admission_id, course_id, academic_year, particular_id, exam_particular_id, fee_status, exam_status, reg_status, manual_status) 
                                                                                            VALUES ('$studentRegistrationNo', '$course_id', '$academic_year', '$particular_id', '$exam_particular_id', '$fee_status', '$exam_status', 'Approve', '$manual_status')";
                                                                            ...
                                                                            // If remaining amount is greater than 0, display "Not Approved"
                                                                            echo "Not Approved";
                                                                        }
                                                                        ?>
                                                                    </span>
