...
if ($chk_tx == "success") {
    ...
    $payment_success = updateAll('tbl_registration_form', $student, '`admission_id`=' . $student['admission_id'] . '');
    if ($payment_success == "success") {

        $success_reg = fetchRow('tbl_registration_form', '`admission_id`=' . $student['admission_id'] . ' ');
        $student_msg = "Dear " . $success_reg["candidate_name"] . ", Thank you for the payment, towards your University Registration Form. Regards NSU";
        sendMessage($mobile_no1, $student_msg);
        ...
        $income['particulars'] = "University Registration Form";
        $income['amount'] = $student['amount'];
        $income['payment_mode'] = $PaymentMode;
        $income['check_no'] = '0';
        $income['bank_name'] = $bank_name;
        $income['income_from'] = 'University Registration Fee';
        $income['post_at'] = $paymentDate;
        $income['table_name'] = 'tbl_registration_form';
        $income['table_id'] = $_SESSION['registration_id'];
...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Student Fee Exam Details </title>
    <!-- Fav Icon -->
            ...
            <section class="course mt-5">
                <div class="container">
                    <div class="sec-title text-center mb-3 aos-init aos-animate" data-aos="fade-up"
                        ...
                        <h2>Registration Fee Payment Details</h2>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="" class="form-control"
                                        value="<?php echo $success_reg['registration_no'] ?>" type="text" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Email Address</label>
                                    <input id="placement_contact_email" value="<?php echo $success_reg['email_id'] ?>"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="placement_contact_phone"
                                        value="<?= fetchRow('tbl_course', '`course_id`=' . $success_reg['course_id'] . '')['course_name'] ?>"
                                        class="form-control" placeholder="Enter Number" type="text" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Session</label>
                                    <input
                                        value="<?= fetchRow('tbl_university_details', '`university_details_id`=' . $success_reg['academic_year'] . '')['academic_session'] ?>"
                                        class="form-control" placeholder="" type="text" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="">Phone Number</label>
                                    <input id="placement_contact_phone" value="<?php echo $success_reg['mobile_no1'] ?>"
                                        class="form-control" placeholder="Enter Number" type="text" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="placement_contact_phone" value="<?php echo $success_reg["amount"]; ?>"
                                        class="form-control" placeholder="Enter Number" type="text" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Transaction ID</label>
                                    <input value="<?php echo $success_reg["transactionid"]; ?>" class="form-control"
                                        placeholder="Enter Designation" type="text" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="">Easebuzz ID</label>
                                    <input type="text" value="<?php echo $success_reg["easebuzzid"]; ?>"
