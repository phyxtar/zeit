...
<body class="hold-transition sidebar-mini" oncontextmenu="return false;">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
                ...
                ?>
            <div class="responsive-container">
                <h1>University Registration Form has been Ended on
                                ...
                                <div class="row">
                                    ...
                                    <div class="card card-secondary" style="width: -webkit-fill-available;">
                                        <div class="card-header">
                                            <h3 class="card-title">INSTRUCTIONS FOR FILLING UP THE REGISTRATION FORM:
                                            </h3>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <ul>
                                                    ...
                                                    <li>The enrolment number, subject code, papers’ name are correctly
                                                        ...
                                                        form.</li>
                                                    <li> Registration fees once paid, not refundable / adjusted in any
                                                        case.</li>
                                    ...
                                    <?php
                                                ...
                                                echo "<h4 style='color:red;'>Dear " . ucfirst($_SESSION["logger_username1"]) . ", Please Clear Your Dues fee to fill up your form.</h4>";
                                            }
                                        } else {
    ...
    function fetch_data() {
        ...
        $.ajax({
            url: 'include/view.php?action=fetch_reg_form',
            type: 'POST',
