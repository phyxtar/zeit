...
<body class="hold-transition sidebar-mini" oncontextmenu="return false;">
    ...
    <div class="wrapper">
        ...
        if (isset($_POST['submit'])) {
            ...
            $student['apaar_id'] = $_POST["apaar_id"];
            ...
            $success_result = insertAll('tbl_examination_form', $student);

            if ($success_result != "success") {
                // if insertion is not possible then updating the data of the student
                $success_result = updateAll('tbl_examination_form', $student, '`admission_id`=' . $student['admission_id'] . ' && `semester_id`=' . $student['semester_id'] . '');
            }
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <?php $_SESSION['exam']["candidate_name"] = $row["admission_first_name"] . " " . $row["admission_middle_name"] . " " . $row["admission_last_name"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="firstname" class="form-control rounded-pill" name="udf1"
                                            ...
                                            readonly>
                                        <?php $_SESSION['exam']["father_name"] = $row["admission_father_name"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="email" class="form-control rounded-pill" name="email"
                                            ...
                                            readonly>
                                        <?php $_SESSION['exam']["email_id"] = $row["admission_emailid_student"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="phone" class="form-control rounded-pill" name="phone"
                                            ...
                                            readonly>
                                        <?php $_SESSION['exam']["mobile_no1"] = $row["admission_mobile_student"]; ?>
                                    </div>
