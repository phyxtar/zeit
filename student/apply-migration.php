...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Apply Migration </title>
...
<body class="hold-transition sidebar-mini" oncontextmenu="return false;">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            WHERE `course_id`='all' && `fee_academic_year` = 'all' && `migrationfee_status` = 'Active' ";
...
//             echo "</pre>";
            ...
            if ($sem_row['form_start_date'] == "") {
                ?>
            <div
                style="width: 800px; margin: 0 auto; background-color: red; color: white; padding: 10px; text-align: center;">
                <h1>Application Form Haven't Started Yet.</h1>
            </div>
            <?php
            ...
            <div
                style="width: 800px; margin: 0 auto; background-color: red; color: white; padding: 10px; text-align: center;">
                <h1>Application Form has been Ended on
                                ...
                                <div class="row">
                                    ...
                                    <div class="card card-secondary" style="width: -webkit-fill-available;">
                                        <div class="card-header">
                                            <h3 class="card-title">APPLICATION FORM FOR ISSUE OF MIGRATION CUM CLC
                                                CERTIFICATE
                                            </h3>
                                        </div>
                                        <div class="card-body table-responsive p-0">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div class="col-6">
                                                        <div class="form-group">
                                                            <label>Migration Form Fee</label>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control  rounded-pill"
                                                                name="amount"
                                                                value="<?php echo $sem_row['migration_fee']; ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <h4 class="text-warning">Dear <strong class="text-dark">
                                        ...
                                        </strong> Application Form Start Form
                                    ...
                                    <h4 class="text-warning">Dear <strong class="text-dark">
                                            <?= ucfirst($_SESSION['user']["admission_first_name"]) ?>
                                        </strong> Application Form has been closed on this date
        ...
        function image_check(element, uploadImageSize) {
            ...
            if (element.files[0].type == "image/jpeg" || element.files[0].type == "application/pdf" || element.files[0]
                .type == "image/jfif" || element.files[0]
                .type == "image/jpg" || element.files[0]
                .type == "image/png") {
                if (!imgpath.value == "") {
    ...
    function fetch_data() {
        ...
        $.ajax({
            url: 'include/view.php?action=fetch_migration_form',
            type: 'POST',
