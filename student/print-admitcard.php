...
<body class="body_pop" style="color:#0d1065;">
    ...
    <table width="740" border="0" align="center" class=""
            ...
            <td align="right" valign="top">
                <table width="100%" border="0">
                    ...
                    <tr>
                        ...
                        $sql12 = "SELECT * FROM tbl_admission WHERE admission_id = '" . $_SESSION['user']['admission_id'] . "'";
                        $result_sql = mysqli_query($con, $sql12);
                        $row_sql = mysqli_fetch_assoc($result_sql);

                        $sql_semester = "SELECT * FROM tbl_allot_semester WHERE admission_id = '" . $row_sql['admission_id'] . "' ORDER BY allot_id DESC LIMIT 1";
                                            ...
                                            <th rowspan="3"
                                                ...
                                                <div style="padding: 2px;">
                                                    <a href="" id="profile" value=""><img
                                                            src="./images/student_images_new/<?php echo $row_exam["passport_photo"]; ?>"
                                                            style="height: 50px;"></a>
                                                    <!-- <a href="" id="profile" value=""><img
                                ...
                                <td>
                                    <table width="100%" class="" style="margin-top: -4px;">
                                        ...
                                        <tbody style="background-size:cover; margin-top:25px;">
                                            <?php
                                            $sql = "SELECT * FROM `tbl_subjects` WHERE 
                                                course_id = '" . $row["course_id"] . "' AND 
                                                 semester_id = '" . $row["semester_id"] . "' AND 
                                                fee_academic_year = '" . $row["academic_year"] . "' AND (specialization_id = '" . $row['specialization_id'] . "' OR specialization_id = '" . $row['specialization_id_dual'] . "' OR COALESCE(specialization_id, '') = '')
                                                 ORDER BY `date_of_examination` ASC";
                                            $rows = $con->query($sql);
        ...
        <table>
            <div class="controller">
                ...
                <div>
                    ...
                    <p style="font-size: 12px;margin-top: 0px;margin-bottom: 3px;"><b>CONTROLLER OF EXAMINATIONS</b></p>
                </div>
            </div>
