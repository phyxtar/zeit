...
if ($chk_tx == "success") {
    ...
    $payment_success = updateAll('tbl_examination_form', $student, '`admission_id`=' . $student['admission_id'] . ' && `semester_id`=' . $student['semester_id'] . '');
    if ($payment_success == "success") {

        $_SESSION = fetchRow('tbl_examination_form', '`admission_id`=' . $student['admission_id'] . ' && `semester_id`=' . $student['semester_id'] . '');
        $student_msg = "Dear ".$_SESSION["candidate_name"].", Thank you for the payment, towards your Examination Form. Regards NSU";
        ...
        $income['particulars'] = "Exam Form";
        $income['amount'] = $student['amount'];
        $income['payment_mode'] = $PaymentMode;
        $income['check_no'] = '0';
        $income['bank_name'] = $bank_name;
        $income['income_from'] = 'Exam Fee';
        $income['post_at'] = $paymentDate;
        $income['table_name'] = 'tbl_examination_form';
        $income['table_id'] = $_SESSION['exam_id'];
            ...
            <section class="course mt-5">
                <div class="container">
                    <div class="sec-title text-center mb-3 aos-init aos-animate" data-aos="fade-up"
                        ...
                        <h2>Exam Fee Payment Details</h2>
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="placement_contact_phone" value="<?php echo $_SESSION['mobile_no1'] ?>"
                                        class="form-control" placeholder="Enter Number" type="text" readonly>
                                </div>
