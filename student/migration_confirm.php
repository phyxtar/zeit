...
$reg_dir = "images/regslip";
$marksheet_dir = "images/marksheet";
$admitcard_dir = "images/admitcard";
...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Migration Form </title>
...
<body class="hold-transition sidebar-mini" oncontextmenu="return false;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><strong>Don't refresh or press back:</strong> Please wait until you receive the paid receipt for
                        your
                        migration application form submission.</p>
    ...
    <div class="wrapper">
        ...
        if (isset($_POST['submit'])) {
            ...
            $student['whatsapp'] = $_POST["whatsapp"];
            $student['address'] = $_POST["address"];
            $student['name_of_the_exam'] = $_POST["name_of_the_exam"];
            $student['session'] = $_POST["session"];
            $student['passfail'] = $_POST["passfail"];
            $student['create_time'] = date('Y-m-d h:m:s');
            $student['status'] = $visible;
            $student['amount'] = 0;


            $photos = fetchRow('tbl_migration_form', '`admission_id`=' . $student['admission_id'] . ' && `course_id`=' . $student['course_id'] . '');

            if ($photos['doc_reg'] == '') {
                $doc_reg_rand = date('Ymdhis') . $_FILES["doc_reg"]["name"];
            } else {
                $doc_reg_rand = $photos['doc_reg_rand'];
            }
            if ($photos['doc_marksheet'] == '') {
                $doc_marksheet_rand = date('Ymdhis') . $_FILES["doc_marksheet"]["name"];
            } else {
                $doc_marksheet_rand = $photos['doc_marksheet_rand'];
            }
            if ($photos['doc_admitcard'] == '') {
                $doc_admitcard_rand = date('Ymdhis') . $_FILES["doc_admitcard"]["name"];
            } else {
                $doc_admitcard_rand = $photos['doc_admitcard_rand'];
            }
            ...
            function file_upload1($image, $destination, $size_in_kb = 1024)
            {
                ...
                if (!in_array($ext, ['jpeg', 'png', 'jpg','pdf','jfif'])) {
                    ...
                    redirect('student/apply_migration');
                    exit;
                }
            ...
            // uploading the student registrtion slip into file
            file_upload1($_FILES["doc_reg"], $reg_dir);
            $student['doc_reg'] = $doc_reg_rand;

            file_upload1($_FILES["doc_admitcard"], $admitcard_dir);
            $student['doc_admitcard'] = $doc_admitcard_rand;
            
            file_upload1($_FILES["doc_marksheet"], $marksheet_dir);
            $student['doc_marksheet'] = $doc_marksheet_rand;

            // inseting the all data of the student into the database
            $success_result = insertAll('tbl_migration_form', $student);

            if ($success_result != "success") {
                // if insertion is not possible then updating the data of the student
                $success_result = updateAll('tbl_migration_form', $student, '`admission_id`=' . $student['admission_id']  . '');
            }
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10">
                            <h1>MIGRATION FORM - For University Campus Programme</h1>
                        </div>
                        <div class="col-sm-2">
            ...
            <section class="content">
                <div class="container-fluid">
		      	...
		      	";
                        ...
                        <form id="payment_form" method="post" action="easebuzz/migration.php?api_name=initiate_payment">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <?php $_SESSION['migration']["candidate_name"] = $row["admission_first_name"] . " " . $row["admission_middle_name"] . " " . $row["admission_last_name"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="firstname" class="form-control rounded-pill" name="udf1"
                                            ...
                                            readonly>
                                        <?php $_SESSION['migration']["father_name"] = $row["admission_father_name"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <?php $_SESSION['migration']["course_name"] = $row_course["course_name"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="email" class="form-control rounded-pill" name="email"
                                            ...
                                            readonly>
                                        <?php $_SESSION['migration']["email_id"] = $row["admission_emailid_student"]; ?>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input id="phone" class="form-control rounded-pill" name="phone"
                                            ...
                                            readonly>
                                        <?php $_SESSION['migration']["mobile"] = $row["admission_mobile_student"]; ?>
                                    </div>

                                    <div class="col-4">
                                        <label for="">Status</label>
                                        <input id="productinfo" class="form-control rounded-pill" name="productinfo"
                                            value="<?php echo "Migration Form Fee Amount"; ?>" placeholder="" readonly>
