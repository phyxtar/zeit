...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Course & Year Wise Hostel Fee Reports </title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Course & Year Wise Hostel Fee Reports </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Course & Year Wise Hostel Fee Report </li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Course & Year Wise Hostel Fee Report</h3>
                        </div>
                            ...
                            <div class="card-body" style="margin-top: 0px;">
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <label> Gender </label>
                                            <select class="form-control rounded-pill" id="type" name="gender">
                                                <option value="all">All</option>
    ...
    <script>
        $(document).ready(function () {
            $('#fetchFeeDataForm').submit(function (event) {
                ...
                $.ajax({
                    url: 'pages/course_wise_fee_reports/hostel_reports.php?action=fetch_fee_list_details',
                    type: 'POST',
