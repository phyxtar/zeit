...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Add Migration </title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add Migration</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-success"><a href="migration_view.php"
                                        style="color: #fff;">
                        ...
                        <form role="form" method="POST" id="add_migration_form">
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-responsive" id="dynamic_field">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="Migration Fee" data-sortable="true" rowspan="2">Migration
                                                Fee
                                            </th>
                                            <th data-field="Status" data-sortable="true" rowspan="2">Status</th>
                                            <th data-field="ExamName" data-sortable="true" rowspan="2">Migration Name
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="migration_fee[]" placeholder="Migration Fee"
                                                    class="form-control" /></td>
                                ...
                                <br>
                                <input type='hidden' name='action' value='add_migration' />
