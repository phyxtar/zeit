...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Add Backlogs </title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add Backlogs</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Add Backlogs</h3>

                            <div class="card-tools">
                                <button type="button" class="btn btn-success"><a href="backlog_view"
                                        style="color: #fff;"> Backlogs List</a></button>
                            </div>
                        </div>
                        <form role="form" method="POST" id="add_backlogs_form">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="time" name="exam_reporting_time">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for=""> Exam Start Time </label>
                                            <input class="form-control" type="time" name="time_of_examination">
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-responsive" id="dynamic_field">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="Exam Fine" data-sortable="true" rowspan="2" width=40%>Exam
                                                Fine</th>
                                            <th data-field="Exam Fee Last Date" data-sortable="true" rowspan="2">Exam
                                                Fee Last Date</th>
                                            ...
                                            <th data-field="Name Of School" data-sortable="true" rowspan="2">Name Of
                                                School</th>
                                            <th data-field="Exam Month" data-sortable="true" rowspan="2">Exam Month</th>
                                            <th data-field="Date of Result" data-sortable="true" rowspan="2">Date of
                                                Result</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="exam_fee" placeholder="Exam Fee"
                                                    class="form-control" /></td>
                                            <td><input type="text" name="exam_fine" placeholder="Exam Fine"
                                                    class="form-control" /></td>
                                            <td><input type="date" name="exam_fee_last_date" placeholder=""
                                                    class="form-control" /></td>
                                            <td><select name="fee_status" class="form-control">
                                                    <option value="0">Select</option>
                                                    <option value="Active">Active</option>
                                                    <option value="Inactive">Inactive</option>
                                                </select></td>
                                            <td><input type="text" name="examname" placeholder="Exam Name"
                                                    class="form-control" /></td>
                                            <td><input type="text" name="name_of_school" placeholder="Name Of School"
                                                    class="form-control" /></td>
                                            <td><input type="text" name="examination_month"
                                                    placeholder="Examination held in the month of"
                                                    class="form-control" /></td>
                                            <td><input type="date" name="date_of_result"
                                                    placeholder="Date of publication of result" class="form-control" />
                                            </td>
                                ...
                                <br>
                                <input type='hidden' name='action' value='add_backlogs' />
                                <div class="col-md-12" id="loader_section"></div>
                                <button type="button" id="add_backlogs_button" class="btn btn-primary">Add</button>
        ...
        $('#add_backlogs_button').click(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#add_backlogs_button').prop('disabled', false);
                }
