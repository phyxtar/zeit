...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Course & Year Wise Full Fee Reports With Active & Inactive Students </title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Course & Year Wise Full Fee Reports With Active & Inactive Students</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Course & Year Wise Full Fee Report With Active & Inactive Students</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Course & Year Wise Full Fee Report With Active & Inactive Students</h3>
                        </div>
    ...
    $(document).ready(function() {
        $('#fetchFeeDataForm').submit(function(event) {
            ...
            $.ajax({
                url: 'pages/course_wise_fee_reports/full_reportss.php?action=fetch_fee_list_details',
                type: 'POST',
