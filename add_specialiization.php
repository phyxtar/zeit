...
<head>
    ...
    <title>NETAJI SUBHAS UNIVERSITY | Specilization </title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Add Specialiization</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Add Specialiization</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Add Specialiization</h3>

                            <div class="card-tools">
                                <button type="button" class="btn btn-success"><a href="specialiization_view"
                                        style="color: #fff;"> Specialiization List</a></button>

                            </div>
                        </div>
                        <form role="form" method="POST" id="add_specialization_form">
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-responsive" id="dynamic_field">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="Semester" data-sortable="true" rowspan="2">Specialiization
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="specialization[]" placeholder="specialization"
                                ...
                                <button type="button" id="add_specialization_button"
    ...
    <script>
        $(function () {
            ...
            $('#add_specialization_button').click(function () {
                $('#loader_section').append('<center id = "loading"><img width="50px" src = "images/ajax-loader.gif" alt="Currently loading" /></center>');
                $('#add_specialization_button').prop('disabled', true);
                $.ajax({
                    url: 'include/controller.php',
                    type: 'POST',
                    data: $('#add_specialization_form').serializeArray(),
                    success: function (result) {
                        ...
                        if (result == "success") {
                            $('#add_specialization_form')[0].reset();
                            $('#error_section').append('<div id = "response"><div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="icon fas fa-check"></i> Specialiization added successfully!!!</div></div>');
                        }
                        if (result == "update") {
                            $('#add_specialization_form')[0].reset();
                            $('#error_section').append('<div id = "response"><div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="icon fas fa-check"></i> Specialiization updated successfully!!!</div></div>');
                        }
                        console.log(result);
                        $('#loading').fadeOut(500, function () {
                            $(this).remove();
                        });
                        $('#add_specialization_button').prop('disabled', false);
                    }
