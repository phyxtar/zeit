    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Hostel Full Report</h1>
                    </div>

                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Hostel Full Report</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title"> Hostel Full Report</h3>
                        <?= $msg ?>
                    </div>
                        ...
                        <div class="card-body" style="margin-top: 0px;">
                            <div class="row">
                                ...
                                <div class="col-1" style="margin-top: 29px;">
                                    <button type="button" onclick="ajaxCall('form_id', 'full_report', 'success')"
