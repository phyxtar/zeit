...
<div class="main-panel">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Hotellers</b></h3>
                    </div>
    ...
    function getHosttelersData() {
        ...
        // alert(course_id + " " + session_id + " " + gender + " " + status);
        $.ajax({
            // url: '/nsucms/include/ajax/get_hosteller_data.php',
            url: '../../include/ajax/get_hosteller_data.php',
            type: 'POST',
            data: {
                'course_id': course_id,
    ...
    function change_semester(semester) {
        if (semester != "all") {
            $.ajax({
                url: '/nsucms/include/ajax/add_semester.php',
                type: 'POST',
                data: {
                    'data': semester
                },
